...
def extract_subject_by_rapidfuzz(query,top_n=1, score_cutoff=80):
    # 텍스트 파일에서 과목명 로드
    with open("data/all_subject_names_unique.txt", encoding="utf-8-sig") as f:
...
if __name__ == "__main__":
    query = "시스템에 관련한 과목 알려줘"
    result = extract_subject_by_rapidfuzz(query)