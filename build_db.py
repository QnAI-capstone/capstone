...
json_dir = "subjectinfo/"  # JSON 파일들이 있는 디렉토리 경로 (필요 시 변경경)
file_list = [f for f in os.listdir(json_dir) if f.endswith(".json")]
#print(file_list)


'''
client.delete_collection(name="collection_Major_English.json")
client.delete_collection(name="collection_Major_Liberal_Arts.json")  
client.delete_collection(name="collection_Major_American_Culture")   
#client.delete_collection(name="collection_subjectinfo")
client.delete_collection(name="collection_Major_Education_Institute.json")
client.delete_collection(name="collection_Major_Philosophy.json")    
client.delete_collection(name="collection_Major_Religious_Studies.json")
client.delete_collection(name="collection_Major_European_Culture.json")
