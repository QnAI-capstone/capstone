...
class HybridRetriever:
    ...
    def retrieve(self, query, top_k_bm25=10, top_k_dpr=3, filter_major=None):
        ...
        embedding_fn = KoSimCSEEmbedding()
        client = PersistentClient(path="./chroma_store")
        collection = client.get_collection(name="collection_subjectinfo", embedding_function=embedding_fn)
    ...
    # Top-K DPR 유사도 정렬
        ...
        final_results = [
            (bm25_candidates_docs[i], bm25_candidates_meta[i]) for i in top_indices
        ]
