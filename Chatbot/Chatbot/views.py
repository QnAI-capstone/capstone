    ...
    if request.method == 'POST':
        ...
        # 사용자가 질문을 입력한 경우
            ...
            if selected_category:
                result = get_response_from_retriever(message, selected_category, chat_log)
                ...
                response = "⚠️ 먼저 질문의 카테고리를 선택해주세요."
        ...
        return JsonResponse({'message': message, 'response': response, 'questions': questions})
